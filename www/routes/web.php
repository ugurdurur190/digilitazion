...
Route::group(['middleware' => 'admin.role'], function () {
    ...
    Route::get('projects/votes/questions/select','App\Http\Controllers\ProjectController@selectQuestion');

    Route::get('projects/situations/filters/{id}','App\Http\Controllers\ProjectController@filterProject');
    Route::get('projects/situations/filters/status/edit/{id}','App\Http\Controllers\ProjectController@editStatus');
    ...
    Route::get('units/list','App\Http\Controllers\UnitController@listUnit');
    Route::get('units/store','App\Http\Controllers\UnitController@storeUnit');
    Route::get('units/edit/{id}','App\Http\Controllers\UnitController@editUnit');
    Route::get('units/delete/{id}','App\Http\Controllers\UnitController@deleteUnit');
});
...
Route::get('projects/canceled/list','App\Http\Controllers\ProjectController@listCanceledProject');
...
Route::get('projects/todoes/commits/store/{id}','App\Http\Controllers\TodoController@storeTodoCommit');
Route::get('projects/todoes/teams/view/{id}','App\Http\Controllers\TodoController@viewTeam');
Route::get('projects/situations/filters/activites/{id}','App\Http\Controllers\ProjectController@viewProjectFilterActivite');
Route::get('projects/comment/store/{id}','App\Http\Controllers\ProjectController@storeComment');
