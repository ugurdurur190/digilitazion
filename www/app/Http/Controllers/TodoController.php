...
use App\Models\ProjectTodoComment;
...
class todoController extends Controller
{
   ...
   public function viewWork($id)
   {
      ...
      $commits=ProjectTodoComment::where('project_id',$id)->get();
   ...
   public function storeTodoCommit(Request $request,$id)
   {
      $comment = new ProjectTodoComment;
      $comment->project_id=$id;
      $comment-> user_id=Auth::user()->id;
      $comment->todo_id=$request->todo_id;
      $comment->comment=$request->commit;
      $comment->save();
      ...
      if (!$comment->save())
      {
         ...
         return Redirect::to('projects/todoes/works/view/'.$comment->project_id);
      }
   }
