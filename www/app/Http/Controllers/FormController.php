...
class FormController extends Controller
{
   ...
   public function storeQuestion(Request $request)
   {
      ...
      if ( ! $questions->save())
      {
         ...
         return Redirect::back()->with('success', 'Soru eklendi!');
      }
   }
   ...
   public function storeProcess(Request $request)
    {
         ...
         if ( ! $process->save())
         {
           ...
           return Redirect::back()->with('success', 'Mevcut süreç eklendi!');
        }
    }
   ...
   public function deleteProcess($id)
   {
      ...
      if ( ! $process->delete())
      {
         ...
         return Redirect::back()->with('success', 'Mevcut süreç silindi!');
      }
   }
