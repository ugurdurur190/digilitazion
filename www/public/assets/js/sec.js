...
function selectAnswerType(){
    ...
    if(x.options[y].value=="radio_opt"){
        ...
        '<input type="text" name="radio[]" class="text-area" style="border:none;" maxlength="50" placeholder="Maksimum 50 karakter..." required /><br/>'+
        '<br/>'+
        '<input type="radio" name="radio[]" disabled/> '+
        '<input type="text" name="radio[]" class="text-area" style="border:none;" maxlength="50" placeholder="Maksimum 50 karakter..." required /><br/>';
        ...
        '<input type="text" name="checkBox[]" class="text-area" style="border:none;" maxlength="50" placeholder="Maksimum 50 karakter..." required /><br/>'+
        '<br/>'+
        '<input type="checkBox" disabled > '+
        '<input type="text" name="checkBox[]" class="text-area" style="border:none;" maxlength="50" placeholder="Maksimum 50 karakter..." required /><br/>';
        ...
        document.getElementById("preview").innerHTML = 
        "<textarea name='text' id='' cols='30' rows='10' class='form-control text-area' disabled='' placeholder='Buraya bir şeyler yazın...'></textarea>";
        var addOptionRadio = document.getElementById("addOptionRadio").style.display = "none";
        var addOptionCheck = document.getElementById("addOptionCheck").style.display = "none";
    }
   }
