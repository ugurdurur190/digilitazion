...
<div class="col-lg-12">
	...
	<div class="row">
		<div class="col-4">
			<h4 style="color: #5A378C;">DEVAM EDEN PROJELER</h4>
		</div>
		
	</div>
    <p class="small" style="color: #190F26;"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Bu alanda Yönetici tarafından devam etmesine karar verilen projeler bulunur. Ve "Proje Çalışma Alanı" bu sayfadadır.  </p>
