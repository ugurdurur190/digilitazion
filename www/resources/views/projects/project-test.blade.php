...
@section('content')
    ...
    <h4 style="color: #5A378C;">Çalışma Alanı</h4>
    <hr/>
    <div id="content">
        <div class="col">
            ...
            @foreach ($todoes as $todo)
                @if ($todo->board_id == 1)
                    <div class="todo-box rounded">
                        ...
                        <button class="container-fluid btn btn-outline-dark mb-2" data-bs-toggle="modal" data-bs-target="#exampleModalss{{ $todo->id }}"> Yorum Alanı</button>
                                    ...
                                    <div class="modal-body">
                                                                            ...
                                                                            <div class="w-100">
                                                                                <div
                                                                                    ...
                                                                                    <h6
                                                                                        ...
                                                                                        <span
                                                                                            class="text-dark ms-2">{{ $commit->comment }}
                                                                                        </span>
                                                                                    </h6>
                                                                                    <p class="mb-0">
                                                                                        {{ $commit->created_at }}</p>
                                        ...
                                        <form action="{{ url('projects/todoes/commits/store',[$projects->id]) }}" method="GET" id="todoCommit-store">
                                            ...
                                            <div class="form-group">
                                                <br/>
                                                <input type="text" class="text-area" style="border: solid 1px" name="commit"
                                                    maxlength="250" placeholder="Maksimum 250 karakter..."
                                                    class="form-control form-control-sm container-fluid" required>
                                            </div>
                                            <br/>
                                            <button class="btn btn-outline-dark" id="todoCommit-submit"><i class="fa fa-paper-plane"></i></button>
                                            <button type="button" class="btn btn-outline-dark text-right" data-bs-dismiss="modal">Geri</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
            ...
            @foreach ($todoes as $todo)
                @if ($todo->board_id == 2)
                    <div class="todo-box rounded">
                        ...
                        <button class="container-fluid btn btn-outline-dark mb-2" data-bs-toggle="modal"
                                ...
                                <div class="modal-content">
                                    <div class="modal-body">
                                        ...
                                        <form action="{{ url('projects/todoes/commits/store',[$projects->id]) }}" method="GET" id="inprogresCommit-store">
                                            ...
                                            <br/>
                                            <button class="btn btn-outline-dark" id="inprogresCommit-submit"><i class="fa fa-paper-plane"></i></button>
                                            <button type="button" class="btn btn-outline-dark text-right" data-bs-dismiss="modal">Geri</button>
                                        </form>
                                    </div>
                                </div>
                                ...
                                <div class="modal-content">
                                    <div class="modal-body">
                                        ...
                                        <form action="{{ url('projects/todoes/commits/store',[$projects->id]) }}" method="GET" id="doneCommit-store">
                                            ...
                                            <br/>
                                            <button class="btn btn-outline-dark" id="doneCommit-submit"><i class="fa fa-paper-plane"></i></button>
                                            <button type="button" class="btn btn-outline-dark text-right" data-bs-dismiss="modal">Geri</button>
                                        </form>
                                    </div>
                                </div>
