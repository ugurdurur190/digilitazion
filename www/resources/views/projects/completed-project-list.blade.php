...
<div class="col-lg-12">
	...
	<div class="row">
		<div class="col-4">
			<h4 style="color: #5A378C;">TAMAMLANAN PROJELER</h4>
		</div>
		
	</div>
    <p class="small" style="color: #190F26;"><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> Bu alanda Yönetici tarafından tamamlandığına karar verilen projeler bulunur. </p>
				...
				<tbody style="border-width: 3px;">
					@foreach($projects as $project)
								<tr>
									...
									<td class="text-center small">{{ $project->created_at->format('d/m/Y')  }}<br/>
									-<br/>
									{{ $project->updated_at->format('d/m/Y')  }}</td>
