...
<div class="col-lg-12">
	...
	<div class="card card-outline card-success">
		...
		<div class="card-header text-center dontPrint" style="background-color: white;border-top:5px solid #660066;">
			<h4 class="card-title" style="color: #5A378C;"><b>Proje Raporu</b></h4>
			<div class="card-tools">
				<button type="button" class="btn btn-sm bg-primary dontPrint	" data-bs-toggle="modal" data-bs-target="#exampleModal">
					PROJE BİLGİLERİ
				</button>
				<a class="btn btn-sm bg-primary" href="{{ url('projects/votes/reports/list') }}">Geri</a>
	...
	<div class="text-center">
		<a class="btn btn-outline-primary" href="{{ url('projects/votes/reports/list') }}">Geri</a>
	</div>
</div>
@endsection