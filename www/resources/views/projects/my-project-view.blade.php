@extends('layouts.menu')
    ...
    <h4 style="color: #5A378C;">PROJE DÜZENLEME SAYFASI</h4>
                    ...
                    <div class="card-body ui-sortable">
                        ...
                        @csrf
                                ...
                                <h5 style="color:#8B0000;">Proje İsmi:</h5>
                                    <textarea name="title" style="background-color:white;" cols='15' rows='5' class='form-control text-area' maxlength="500" placeholder="{{ $projects->title }}"></textarea><pre></pre>
                                <br/>

                                <h5 style="color:#8B0000;">Proje Açıklaması:</h5>
                                <textarea name="description" style="background-color:white;" cols='15' rows='5' class='form-control text-area' maxlength="1000" placeholder="{{ $projects->description }}"></textarea><pre></pre>
                                <br/>
                                                    ...
                                                    <div class="col">
                                                        @if($answers->where('question_id',$question->id)->count() == 0)
                                                            @foreach(explode("|",$question->frm_option) as $k => $v)
                                                                ...
                                                                <input type="text" class="text-area" name="radio[]" style="border: none; background-color:white;" disabled value="{{ $v }}" /><pre></pre>
                                                            @endforeach
                                                        @else
                                                            @foreach(explode("|",$question->frm_option) as $k => $v)
                                                        ...
                                                        @foreach($answers->where('question_id',$question->id) as $answer)
                                                            @foreach(explode("|",$question->frm_option) as $k => $v)
                                                                @foreach(explode("|",$answer->answer) as $a => $b)
                                                                    ...
                                                                    <input type="text" class="text-area" style="border: none; background-color:white;" value="{{ $v }}" disabled/><pre></pre>
                                                                    @endif
                                                                @endforeach
                                                            @endforeach
                                                        @endforeach
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <a class="btn btn-outline-danger delete" href="{{ url('my-projects/question/delete',[$question->id]) }}">
                                                                                Sil
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                                    ...
                                                    <div class="col">
                                                        @if($answers->where('question_id',$question->id)->count() == 0)
                                                            @foreach(explode("|",$question->frm_option) as $k => $v)
                                                                ...
                                                                <input type="text" class="text-area" name="checkBox[]" style="border: none; background-color:white;" disabled value="{{ $v }}" /><pre></pre>
                                                            @endforeach
                                                        @else
                                                            @foreach(explode("|",$question->frm_option) as $k => $v)
                                        ...
                                        @elseif($question->type=="textfield_s")
                                            <div>
                                                <p><b>{{ $question->question }}</b></p>
                                                    <div class="">
                                                        @foreach($answers->where('question_id',$question->id) as $answer)                                   
                                                            <textarea name='text{{$question->id}}' id='' style="background-color:white;" cols='15' rows='5' class='form-control text-area' maxlength="1000" placeholder="{{ $answer->answer }}"></textarea><pre></pre>      
                                                        @endforeach

                                                        @if($answers->where('question_id',$question->id)->count() == 0)
                                                            <textarea name='text{{$question->id}}' id='' style="background-color:white;" cols='15' rows='5' class='form-control text-area' maxlength="1000" placeholder="Maksimum 1000 karakter..." required></textarea><pre></pre>
                                                        @endif
                                                    </div>
                                                        ...
                                                        <div class="modal fade" id="projectProcess{{$process->id}}" tabindex="-1" aria-labelledby="exampleModalLabelProcess" aria-hidden="true">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-outline-dark" data-bs-dismiss="modal">Geri</button>
                                                                            <a class="btn btn-outline-danger delete" href="{{ url('my-projects/process/delete',[$process->id]) }}">
                                                                                Sil
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                                ...
                                                <div class='card-body'>
                                                    <div class="row">
                                                        <div class="col-sm">
                                                            ...
                                                            <h4>{{$process->title}}</h4>
                                                            <br/>
                                                            <b><textarea class="form-control text-area" style="height:50px; width:300px; background-color:white; border:none;" disabled>Süreç Aşamaları?</textarea></b><br/><br/>
                                                            <b><textarea class="form-control text-area" style="height:50px; width:300px; background-color:white; border:none;" disabled>Hardcopy onayları var mı?</textarea></b><br/><br/>
                                                            <b><textarea class="form-control text-area" style="height:50px; width:300px; background-color:white; border:none;" disabled>Manuel veri toplama süreci var mı?</textarea></b><br/><br/>
                                                            <b><textarea class="form-control text-area" style="height:50px; width:300px; background-color:white; border:none;" disabled>Sürecin mevcut manuel aşama sayısı?</textarea></b><br/><br/>
                                                            <b><textarea class="form-control text-area" style="height:50px; width:300px; background-color:white; border:none;" disabled>Sürecin mevcut dijital aşama sayısı?</textarea></b><br/><br/>
                                                            <b><textarea class="form-control text-area" style="height:50px; width:300px; background-color:white; border:none;" disabled>Sürecin mevcut dijital olgunluk oranı?</textarea></b><br/><br/>
                                                            <b><textarea class="form-control text-area" style="height:60px; width:300px; background-color:white; border:none;" disabled>Dijitalleşme olgunluk arttırma önerileri/projeleri</textarea></b><br/><br/>
                                                        </div>
                                                        ...
                                                        <div class="col-sm">
                                                            ...
                                                            @foreach($processAnswers as $processAnswer)
                                                                @if($processAnswer->current_process_id == $process->id)
                                                                    @foreach(explode("|",$processAnswer->answer) as $k => $v)
                                                                        <textarea class="bold text-area" name="answer{{$process->id}}[]" style="height:70px; width:400px; background-color:#EDE9F2;" maxlength="500" placeholder="{{ $v }}"></textarea><br/><br/>
                                                                    @endforeach
                                                                @endif
                                                            @endforeach
                                                            ...
                                                            @if($processAnswers->where('current_process_id',$process->id)->count() == 0)
                                                                ...
                                                                <textarea class="bold text-area" name="answer{{$process->id}}[]" style="height:70px; width:400px; background-color:#EDE9F2;"  maxlength="500" placeholder="Maksimum 250 karakter..."></textarea><br/><br/>
                                                                <textarea class="bold text-area" name="answer{{$process->id}}[]" style="height:70px; width:400px; background-color:#EDE9F2;"  maxlength="500" placeholder="Maksimum 250 karakter..."></textarea><br/><br/>
                                                                <textarea class="bold text-area" name="answer{{$process->id}}[]" style="height:70px; width:400px; background-color:#EDE9F2;" maxlength="500" placeholder="Maksimum 250 karakter..."></textarea><br/><br/>
                                                                <textarea class="bold text-area" name="answer{{$process->id}}[]" style="height:70px; width:400px; background-color:#EDE9F2;" maxlength="500" placeholder="Maksimum 250 karakter..."></textarea><br/><br/>
                                                                <textarea class="bold text-area" name="answer{{$process->id}}[]" style="height:70px; width:400px; background-color:#EDE9F2;" maxlength="500" placeholder="Maksimum 250 karakter..."></textarea><br/><br/>
                        ...
                        <div class="card-header-light text-center">
                            <div class="card-tools">
                                    @if(Auth::user()->privilege_id == '1')
                                    <button type="button" class="btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#newProjectQuestion" data-bs-whatever="@mdo">
                                        <i class="fa fa-plus fa-lg"> Yeni Soru Oluştur</i>
                                    </button>

                                    <button type="button" class="btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#newProjectProcess" data-bs-whatever="@mdo">
                                        <i class="fa fa-plus fa-lg"> Mevcut Süreç Oluştur</i>
                                    </button>
                                    
                                    @endif
                                    <input type="submit" class="btn btn-outline-dark" value="Güncelle" id="submit"/>

                                    <a class="btn btn-outline-dark" href="{{ url('my-projects/list') }}">Geri</a>
                            </div>
                        </div>
                        </form>
                    </div>
                        ...
                        <div class="modal-body">
                            <form action="{{ url('my-projects/question/store') }}" method="GET" id="newProjectQuestion-store">
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm">
                                            <textarea class="bold text-area" name="question" id="question" oninput='this.style.height = "";this.style.height = this.scrollHeight + "px"' maxlength="500" placeholder="Maksimum 500 karakter..." style="height:50px; width:400px; border:none;" required></textarea>
                                        </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <input type="submit" class="btn btn-outline-dark" value="Ekle" id="newProjectQuestion-submit" />
                                    <button type="button" class="btn btn-outline-dark" data-bs-dismiss="modal">Geri</button>
                                </div>
                            </form>
                        </div>
                                ...
                                @csrf
                                    ...
                                    <div class="container">
                                        <div class="row">
                                                ...
                                                <div class="col-sm">
                                                    <textarea class="bold text-area" name="title" oninput='this.style.height = "";this.style.height = this.scrollHeight + "px"' maxlength="500" placeholder="Maksimum 500 karakter..." style="height:50px; width:400px; border:none;" required></textarea>
                                                </div>
                                                ...
                                                <input type='text' style='border:none; width:500px; background-color:white;' disabled value='Süreç Aşamaları?' /><br/>
                                                    <textarea class="bold text-area" oninput='this.style.height = "";this.style.height = this.scrollHeight + "px"' style="height:50px; width:400px;" disabled></textarea><br/><br/>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <input type="submit" class="btn btn-outline-dark" value="Ekle" id="newProjectProcess-submit" />
                                        <button type="button" class="btn btn-outline-dark" data-bs-dismiss="modal">Geri</button>
                                    </div>
                            </form>
                        </div>
