@extends('layouts.menu')
    @section('content')
        ...
        <div class="col-lg-12">
            <h4 style="color: #5A378C;">Yeni Görev</h4>
                        ...
                        <div class="row">
                            <div class="col-md-6 border-right">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="title" class="form-control form-control-sm text-area" maxlength="50" placeholder="Maksimum 50 karakter..." required>
                                </div>
