@extends('layouts.menu')
	...
	<div class="col-lg-12">
	<h4 style="color: #5A378C;">Yeni Kullanıcı</h4>
	<hr/>
	<a class="btn btn-outline-dark float-right mb-2" href="{{ url('users/list') }}">Kullanıcı Listesi</a>
			...
			<div class="card-body">
				...
				@csrf
					<div class="row">
						<div class="col-md-6 border-right">
							<div class="form-group">
								...
								<input type="text" name="name" class="form-control form-control-sm text-area" maxlength="50" placeholder="Maksimum 50 karakter..." required>
							</div>
							<br/>
							<div class="form-group">
					...
					<hr>
						...
						<a class="btn btn-outline-dark mr-2" href="{{ url('users/list') }}">Geri</a>
				</form>
