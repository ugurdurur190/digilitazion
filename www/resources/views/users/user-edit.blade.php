@extends('layouts.menu')
	...
	<div class="col-lg-12">
	<h4 style="color: #5A378C;">Kullanıcı Düzenle</h4>
	<hr/>
		<div class="card">
			<div class="card-body">
					...
					<div class="row">
						<div class="col-md-6 border-right">
							<div class="form-group">
								...
								<input type="text" name="name" class="form-control form-control-sm text-area" value="{{ $users->name }}" maxlength="50" placeholder="Maksimum 50 karakter..." required>
							</div>
                            <br/>
							<div class="form-group">
