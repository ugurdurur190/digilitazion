...
@inject('notification' , 'App\Http\Controllers\Controller')
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="UTF-8">
    ...
    <body style="background-color: #F2EFE9; min-width: 768px;">
        ...
        <header style="background-color: white;" class="header dontPrint" id="header">
            ...
            <div class="header__toggle">
                <div class="dropdown dontPrint">
                    ...
                    <a class="btn btn-flat" href="{{ route('signout') }}">
                                ...
                                @foreach($notification->getUnratedProjects() as $unratedProject)
                                    <div class="rounded text-center" style="background-color:#EDE9F2;">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <br/>
                                                <a class="btn btn-outline-dark" href="{{ url('projects/vote',[$unratedProject->id]) }}">
                                                    Git
                                                </a>
                                            </div>
                                        </div>
                                ...
                                @foreach($notification->getUnapprovedProjects() as $unapprovedProject)
                                    <div class="rounded text-center" style="background-color:#EDE9F2;">
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <br/>
                                                <a class="btn btn-outline-dark" href="{{ url('projects/units/approval',[$unapprovedProject->id]) }}">
                                                    Git
                                                </a>
                                            </div>
                                        </div>
        ...
        <div id="mySidebar" class="sidebar" style="background-color: #660066;" onmouseover="toggleSidebar()" onmouseout="toggleSidebar()">
                ...
                <div>
                    ...
                    <a href="{{ url('/') }}"><span><i class='bx bx-layer nav__logo-icon'></i><span class="icon-text">&nbsp;&nbsp;&nbsp;&nbsp;Anasayfa</span></a>

                    @if(Auth::user()->privilege_id != '5')
                        <a href="{{ url('dashboard') }}"><span><i class='bx bx-grid-alt nav__logo-icon' ></i><span class="icon-text">&nbsp;&nbsp;&nbsp;&nbsp;Dashboard</span></a>
                    @endif

                    @if(Auth::user()->privilege_id == '1')
                        <a href="{{ url('users/list') }}"><span><i class='bx bx-user nav__logo-icon' ></i><span class="icon-text">&nbsp;&nbsp;&nbsp;&nbsp;Kullanıcılar</span></a>
                    @endif

                    @if(Auth::user()->privilege_id != '5')
                        <a href="{{ url('forms/list') }}"><span><i class='bx bx-message-square-detail nav__logo-icon' ></i><span class="icon-text">&nbsp;&nbsp;&nbsp;&nbsp;Proje Formu</span></a>

                        <a href="{{ url('my-projects/list') }}"><span><i class='bx bx-edit nav__logo-icon' ></i><span class="icon-text">&nbsp;&nbsp;&nbsp;&nbsp;Proje Düzenle</span></a>
        
                        <a href="{{ url('projects/list') }}"><span><i class='bx bx-select-multiple nav__logo-icon' ></i><span class="icon-text">&nbsp;&nbsp;&nbsp;&nbsp;Proje Anketi</span></a>
                        
                        <a href="{{ url('projects/votes/reports/list')}}"><span><i class='bx bx-bar-chart-alt-2 nav__logo-icon' ></i><span class="icon-text">&nbsp;&nbsp;&nbsp;&nbsp;Proje Anket Sonucu</span></a>
                    @endif

                    <a href="{{ url('projects/continues/list') }}"><span><i class='bx bx-select-multiple nav__logo-icon' ></i><span class="icon-text">&nbsp;&nbsp;&nbsp;&nbsp;Devam Eden Projeler</span></a>
                
                    <a href="{{ url('projects/completed/list') }}"><span><i class='bx bx-select-multiple nav__logo-icon' ></i><span class="icon-text">&nbsp;&nbsp;&nbsp;&nbsp;Tamamlanan Projeler</span></a>

                    <a href="{{ url('projects/canceled/list') }}"><span><i class='bx bx-select-multiple nav__logo-icon' ></i><span class="icon-text">&nbsp;&nbsp;&nbsp;&nbsp;İptal Edilen Projeler</span></a>
                    
                    <a href="{{ url('user-guide') }}"><span><i class='bx bx-book nav__logo-icon' ></i><span class="icon-text">&nbsp;&nbsp;&nbsp;&nbsp;Kullanım Kılavuzu</span></a>
                
                    @if(Auth::user()->privilege_id != 5)
                        <a href="{{ url('video') }}"><span><i class='bx bx-video nav__logo-icon' ></i><span class="icon-text">&nbsp;&nbsp;&nbsp;&nbsp;Kullanım Videosu</span></a>
                    @endif
