@extends('layouts.menu')
    ...
    <div class="row">
		<div class="col-3">
			<h4 style="color: #5A378C;">Proje Tanıtım Formu</h4>
		</div>
                                            ...
                                            <div class="" >
                                                <p><b>{{ $question->question }}</b></p>
                                                    ...
                                                    @foreach(explode("|",$question->frm_option) as $k => $v)
                                                            ...
                                                            <input class="text-area" type="text" name="radio[]" style="border: none; background-color:white;" disabled value="{{ $v }}" /><pre></pre>
                                                    @endforeach
                                        ...
                                        @elseif($question->type=="check_opt")
                                            <div class="" >
                                                ...
                                                @foreach(explode("|",$question->frm_option) as $k => $v)
                                                        ...
                                                        <input class="text-area" type="text" name="checkBox[]" style="border: none; background-color:white;" disabled value="{{ $v }}" /><pre></pre>
                                                @endforeach
                                                        @if(Auth::user()->privilege_id == '1')
                                                            <button type="button" class="btn btn-flat" data-bs-toggle="modal" data-bs-target="#exampleModal{{$question->id}}">
                                                                <i class="fa fa-trash fa-lg text-danger"></i>
                                        ...
                                        <div class="container-fluid">
                                            @foreach($units as $unit)
                                                @if($unit->id == 1 || $unit->id == 2)
                                                    ...
                                                    <input class="text-area" type="text" style="border: none; background-color:white; color:#8B0000;" value="{{ $unit->unit }}" disabled/><pre></pre>
                                                @else
