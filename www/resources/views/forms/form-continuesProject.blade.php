@extends('layouts.menu')
    ...
    <script type="text/javascript">
            ...
            $('#continues-project-store').on('submit', function () {
    ...
    <div class="row">
		<div class="col-4">
			<h4 style="color: #5A378C;">Devam Eden Proje Giriş Formu</h4>
		</div>
            ...
            <div class="col-md-8">
                <div class="card card-outline card-success">
                    <div class="card-header p-0 py-2 text-center" style="background-color: white;border-top: 5px solid #660066">
                        <h3 class="card-title" style="color: #5A378C;">Form Soruları</h3>
                    </div>

                    

                    <div class="card-body ui-sortable">
                        <form action="{{ url('projects/store') }}" method="POST" id="continues-project-store">
                        @csrf
                            <input type="hidden" name="formId" class="form-control form-control-sm" value="{{ $forms->id }}">

                                <p style="color:#8B0000;"><b>*Proje Sahibi:</b></p>
                                <div>
                                    <select name="userId" class="form-select short">
                                ...
                                <div class="">
                                    <textarea class="form-control text-area" name="title" style="background-color:white;" cols='15' rows='5' maxlength="500" placeholder="Maksimum 500 karakter..." required></textarea><pre></pre>
                                </div>

                                <p style="color:#8B0000;"><b>*Proje Açıklaması:</b></p>
                                <div class="">
                                    <textarea class="form-control text-area" name="description" style="background-color:white;" cols='15' rows='5' maxlength="1000" placeholder="Maksimum 1000 karakter..." required></textarea><pre></pre>
                                </div>
                                    ...
                                    <input type="hidden" name="frm_option[]" class="form-control form-control-sm" value="{{ $question->frm_option}}">
                                                                ...
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <a class="btn btn-outline-danger delete" href="{{ url('forms/question/delete',[$question->id]) }}">
                                                                                Sil
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                        ...
                                        @elseif($question->type=="textfield_s")
                                            <div>
                                                ...
                                                @foreach(explode("|",$question->frm_option) as $k => $v)
                                                    <div class="">
                                                        <textarea class="form-control text-area" name='text{{$question->id}}' id='' style="background-color:white;" cols='15' rows='5' maxlength="1000" placeholder="Maksimum 1000 karakter..." required></textarea><pre></pre>
                                                    </div>
                                                @endforeach
                                                        @if(Auth::user()->privilege_id == '1')
                                                            <button type="button" class="btn btn-flat" data-bs-toggle="modal" data-bs-target="#exampleModal{{$question->id}}">
                                        ...
                                        <div class='card'>
                                                        ...
                                                        <div class="modal fade" id="exampleModalProcess{{$processes->id}}" tabindex="-1" aria-labelledby="exampleModalLabelProcess" aria-hidden="true">
                                                                <div class="modal-dialog">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            <button type="button" class="btn btn-outline-dark" data-bs-dismiss="modal">Geri</button>
                                                                            <a class="btn btn-outline-danger delete" href="{{ url('forms/process/delete',[$processes->id]) }}">
                                                                                Sil
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                            ...
                                            <div id='collapse{{$processes->id}}' class = 'collapse' data-parent = '#accordion' >
                                                <div class='card-body'>
                                                    ...
                                                    <textarea class="bold text-area" name="answer{{$processes->id}}[]" oninput='this.style.height = "";this.style.height = this.scrollHeight + "px"' maxlength="500" placeholder="Maksimum 500 karakter..." style="height:50px; width:400px; border:none;" required></textarea><br/><br/>
                                        ...
                                        <div class="container-fluid">
                                            @foreach($units as $unit)
                                                @if($unit->id == 1 || $unit->id == 2)
                                                    ...
                                                    <input type="text" class="text-area" style="border: none; background-color:white; color:#8B0000;" value="{{ $unit->unit }}" disabled/><pre></pre>
                                                @else
                        ...
                        <div class="container-fluid">
                                <div class="card mb-3" style="max-width: 50rem;">
                                    <div class="card-header" style="background-color: white;border-top: 5px solid #660066">
                                        <h4 class="card-title"  style="color:#8B0000;">*Proje Değerlendirme Oranı:</h4>

                                    </div>
                                    <div class="card-body p-0 py-2">
                                        <div class="container-fluid">
                                            <b>%</b> <input type="number" name="score" placeholder="Proje Değerlendirme Oranı" style="width: 15em" min="0" max="100" required />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-header-light text-center">
                            <div class="card-tools">
                                    @if(Auth::user()->privilege_id == '1')
                                    <button type="button" class="btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#newQuestion" data-bs-whatever="@mdo">
                                        <i class="fa fa-plus fa-lg"> Yeni Soru Oluştur</i>
                                    </button>

                                    <button type="button" class="btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#newProcess" data-bs-whatever="@mdo">
                                        <i class="fa fa-plus fa-lg"> Mevcut Süreç Oluştur</i>
                                    </button>
                                    
                                    @endif
                                    <input type="submit" class="btn btn-outline-dark" value="Gönder" id="submit"/>
                            </div>
                        </div>
                        </form>
                    </div>
                        ...
                        <div class="modal-body">
                            <form action="{{ url('forms/question/store') }}" method="GET" id="question-store">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <input type="submit" class="btn btn-outline-dark" value="Ekle" id="questionStore-submit" />
                                    <button type="button" class="btn btn-outline-dark" data-bs-dismiss="modal">Geri</button>
                                </div>
                            </form>
                        </div>
                            ...
                            <form action="{{ url('forms/process/store') }}" method="GET" id="process-store">
                                ...
                                <input type="hidden" name="form_id" class="form-control form-control-sm" value="{{ $forms->id }}" required>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <input type="submit" class="btn btn-outline-dark" value="Ekle" id="processStore-submit" />
                                        <button type="button" class="btn btn-outline-dark" data-bs-dismiss="modal">Geri</button>
                                    </div>
                            </form>
                        </div>
